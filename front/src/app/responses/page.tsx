              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {response.user._id === response.survey.creator._id ? `${response.user.name} a répondu le` : "Vous avez répondu le"} {format(new Date(response.created_at), "PPP 'à' HH:mm", { locale: fr })}
                  </p>
                </div>
              </Link>
              {showEditButton && (
